...
export default function A() {
  ...
  let InGiY_2 = 127.12631; // 정문 지나고 삼거리 Y좌표
    ...
    <View style={styles.rumain}>
      ...
      <View style={styles.bus}>
        ...
        <View style={styles.textstyle}>
          ...
          <Button title="데이터 새로고침" onPress={GetLocationData}></Button>

          <Text>이공 도착까지 약: {}분</Text>
        </View>
      </View>
    </View>
  );
